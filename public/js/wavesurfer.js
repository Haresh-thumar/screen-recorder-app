  ...
  function i(t, e, i, n, s = 3, r = 0, o = 100) {
    ...
    const h = (h) => {
      ...
      const v = Date.now(),
        p = (n) => {
          if (
            (n.preventDefault(), n.stopPropagation(), a && Date.now() - v < o)
          )
            return;
          const r = n.clientX,
            l = n.clientY,
        ...
        m = (t) => {
          (t.relatedTarget && t.relatedTarget !== document.documentElement) ||
            g(t);
        },
        f = (t) => {
      ...
      document.addEventListener("pointermove", p),
        ...
        document.addEventListener("click", f, { capture: !0 }),
        (l = () => {
  ...
  class r extends t {
    constructor(t, e, i = 0) {
      ...
      super(),
        ...
        (this.resizeStart = null === (o = t.resizeStart) || void 0 === o || o),
        (this.resizeEnd = null === (a = t.resizeEnd) || void 0 === a || a),
        (this.color =
          null !== (l = t.color) && void 0 !== l ? l : "rgba(0, 0, 0, 0.1)"),
        (this.minLength =
          null !== (h = t.minLength) && void 0 !== h ? h : this.minLength),
        (this.maxLength =
          null !== (d = t.maxLength) && void 0 !== d ? d : this.maxLength),
        (this.channelIdx =
          null !== (u = t.channelIdx) && void 0 !== u ? u : -1),
        (this.contentEditable =
          null !== (c = t.contentEditable) && void 0 !== c
            ? c
            : this.contentEditable),
    ...
    onResize(t, e) {
      this.resize &&
        (this.resizeStart || "start" !== e) &&
        (this.resizeEnd || "end" !== e) &&
        this._onUpdate(t, e);
    }
    onEndResizing() {
    ...
    setOptions(t) {
      ...
      if (
        ...
        (this.start = this.clampPosition(
          ...
          (this.end = this.clampPosition(
            null !== (i = t.end) && void 0 !== i ? i : n ? this.start : this.end
          )),
          this.renderPosition(),
          this.setPart();
      }
      ...
      void 0 !== t.resizeStart && (this.resizeStart = t.resizeStart),
        void 0 !== t.resizeEnd && (this.resizeEnd = t.resizeEnd);
    }
    remove() {
      this.emit("remove"),
      ...
      this.subscriptions.push(
        this.wavesurfer.on("timeupdate", (e) => {
          const i = this.regions.filter(
            (t) =>
              t.start <= e && (t.end === t.start ? t.start + 0.05 : t.end) >= e
          );
          i.forEach((e) => {
    ...
    virtualAppend(t, e, i) {
      const n = () => {
        ...
        const n = this.wavesurfer.getWidth(),
          ...
          l =
            a + (Math.round(((t.end - t.start) / o) * r) || 1) > s && a < s + n;
        l && !i.parentElement
          ? e.appendChild(i)
          : !l && i.parentElement && i.remove();
      };
      setTimeout(() => {
        if (!this.wavesurfer) return;
        n();
      ...
      return i(
        ...
        (e) => {
          ...
          const s = this.wavesurfer.getDuration(),
            ...
            u = ((e + 5) / h) * s;
          (o = new r(
            Object.assign(Object.assign({}, t), { start: d, end: u }),
            s,
            l
          )),
