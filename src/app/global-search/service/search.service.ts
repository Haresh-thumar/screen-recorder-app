...
//     // **Fix: Escape special characters and allow multi-word search**
...
//       if (node.nodeValue?.match(regex) && node.parentNode) {
...
//           ...Array.from(
//             parent.querySelectorAll('.highlight') as NodeListOf<HTMLElement>
//           )
//         );
//       }
//     }
